...
![Lambda Function Code](screenshots/1-Lambda-Function-Code.png)
...
![Lambda Execution Output](screenshots/2-Lambda-Execution-Output.png)
...
![CloudWatch Log Group](screenshots/3-CloudWatch-Log Group.png)
...
![CloudWatch Log Stream](screenshots/4-CloudWatch-Log-Stream.png)
...
![CloudWatch Log Events](screenshots/5-CloudWatch-Log-Events.png)
...
![S3 Logs Stored](screenshots/6-S3-Bucket-(Logs-Stored).png)
...
![Bucket Policy](screenshots/7-S3-Bucket-Policy.png)
...
![Athena Query Settings](screenshots/8-Athena-Query-Settings.png)
...
![Athena Table Creation](screenshots/9-Athena-Table-Creation.png)
...
![Athena Query Results](screenshots/10-Athena-Query-Results.png)
...
![Athena Result](screenshots/11-Athena-Result.png)
...
- Learned CloudWatch log management
- Understood centralized log architecture
- Integrated CloudWatch with Amazon S3
- Queried logs using Amazon Athena
- Implemented log analytics workflow

---

## Key Takeaway

Centralized logging improves observability by collecting logs from multiple resources into one place. It simplifies monitoring, troubleshooting, and large-scale analysis.
